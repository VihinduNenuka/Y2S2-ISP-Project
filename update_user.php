...
if(isset($_POST['submit'])){
   ...
   if($old_pass == $empty_pass){
      ...
      if($new_pass != $empty_pass){
         $update_admin_pass = $conn->prepare("UPDATE `account` SET password = ? WHERE id = ?");
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="enter your username" maxlength="20"  class="box" value="<?= $fetch_profile["Username"]; ?>">
